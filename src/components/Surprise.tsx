...
import CatCake from './images/cat-face-cake.jpeg'
import ScImage from './images/sc.png';
import FamImage from './images/fam.jpeg';
import GrpImage from './images/grp.jpeg';
import RoshImage from './images/rosh.jpeg';
...
<video
  src={VideoFile}
  className="w-70 h-70 md:w-80 md:h-80 rounded-lg object-cover"
  autoPlay
  loop
  muted
  playsInline
...
{stage >= 4 && (
  <motion.div
    ...
    animate={{ scale: 1 }}
    transition={{ duration: 0.8, ease: 'easeOut' }}
    className="absolute flex justify-start items-start w-full"
    style={{ top: '80px', left: '20px' }} // Increased `top` from 20px to 80px
  >
    <img 
      src={MeImage} 
...
{stage >= 4 && (
  ...
  >
    <img 
      src={FamImage} 
      className="w-48 h-48 md:w-64 md:h-64 rounded-lg object-cover mt-10 pt-10" 
      alt="Passport Photo" 
    />
  </motion.div>
)}
...
{stage >= 4 && (
  <motion.div
    ...
    animate={{ scale: 1 }}
    transition={{ duration: 0.8, ease: 'easeOut' }}
    className="absolute flex justify-start items-end w-full"
...
{stage >= 4 && (
  <motion.div
    ...
    animate={{ scale: 1 }}
    transition={{ duration: 0.8, ease: 'easeOut' }}
    className="absolute flex justify-end items-end w-full"
    style={{ bottom: '20px', right: '20px' }} // Move to bottom right
  >
    <img 
      src={RoshImage} 
      className="w-48 h-48 md:w-64 md:h-64 rounded-lg object-cover" 
